...
This project was developed in **under 1 hour** as part of the **MIS Breakthrough Hackathon**, a high-pressure event encouraging innovation in solving real-world cybersecurity issues. The event focused on integrating **AI tools like Copilot** to accelerate development and foster collaborative problem-solving.
